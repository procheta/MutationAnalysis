...
def output_comet(args, mutations, results, collections, ks, runNum, maxPermutedWeight, permutedN):
	...
	# output results 
        ...
        #Changing Path
	fPrefix = "/home/procheta/comet_country_phi_output/"+lineage+"."+str(ks[0]) 
        #+ iter_num('comet', runNum, ks, args.accelerator)	
...
def output_comet_viz(args, mutations, resultsTable, maxPermutedWeight, permutedN):
	...
	if args.verbose: print "* Choosing delta..."
        ...
        lineage=args.lineage_name
        ##Create Graph Output
        graph_path="/home/procheta/comet_country_graph_output/"+lineage+".txt"
