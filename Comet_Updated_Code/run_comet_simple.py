...
def get_parser():
    ...
    parser.add_argument('-mf', '--min_freq', type=int, default=10,
    ...
    # CoMEt MCMC
    parser.add_argument('-N', '--num_iterations', type=int, default=pow(10, 1),
                        help='Number of iterations of MCMC.')
    parser.add_argument('-NStop', '--n_stop', type=int, default=pow(10, 1),
    ...
    parser.add_argument('-lineage', '--lineage_name', 
                        help=argparse.SUPPRESS)
